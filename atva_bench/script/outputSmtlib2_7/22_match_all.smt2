...
(assert (str.in_re tweet is_str_re))
(declare-const hashtags String)
(assert (str.in_re hashtags is_seq_re))
...
(assert (= (seq_len hashtags) 2))
(assert (= (seq_nth hashtags 0) "#weather"))
(assert (= (seq_nth hashtags 1) "#sunset"))
