...
(assert (str.in_re items is_seq_re))
(declare-const updated String)
(assert (str.in_re updated is_seq_re))

(assert (= items (str.++ (str.++ seq_spliter "x") (str.++ seq_spliter "y") (str.++ seq_spliter "z"))))
(assert (= updated (seq_write items 1 "w")))
(assert (= (seq_nth updated 1) "w"))
