...
from toSmtlib2_7 import translate
...
if __name__ == "__main__":
    solvers = load_solvers("solvers.json")
    interfaces = {
        "Z3": Z3Interface(),
        "CVC5": CVC5Interface(),
    ...
    benchmark_dir = script_root / "../bench"
    benchmarks = [str(p) for p in Path(benchmark_dir).rglob("*.smt2")]

    run_all(solvers, interfaces, benchmarks)
