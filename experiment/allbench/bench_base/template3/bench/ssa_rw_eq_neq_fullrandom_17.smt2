...
(define-fun w_x_4 () (Seq String) (seq.write w_x_3 3 x))
...
(define-fun r_x_3 () String (seq.nth w_x_4 0))
(define-fun r_x_4 () String (seq.nth w_x_4 2))
(define-fun r_y_1 () String (seq.nth w_y_4 1))
(define-fun r_y_2 () String (seq.nth w_y_4 3))
(define-fun r_y_3 () String (seq.nth w_y_4 2))
(define-fun r_y_4 () String (seq.nth w_y_4 0))
