...
(assert (str.in_re fields is_seq_re))
(declare-const csv_row String)
(assert (str.in_re csv_row is_str_re))

(assert (= fields (str.++ (str.++ seq_spliter "alice") (str.++ seq_spliter "30") (str.++ seq_spliter "engineer"))))
(assert (= csv_row (seq_join fields ",")))
