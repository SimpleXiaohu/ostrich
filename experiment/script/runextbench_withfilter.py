...
if __name__ == "__main__":
    ...
    id_solvers = ["OSTRICH-Seq"]  # Add valid solvers here
    solvers = {k: v for k, v in solvers.items() if k in id_solvers}
    interfaces = {
        "OSTRICH-Seq": OSTRICHSEQInterface(),
        # Add more solvers here...
    }

    benchmark_dir = script_root / "../allbench/bench_ext/with_filter_matchall"
