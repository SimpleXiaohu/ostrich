...
object DenghangTests extends Properties("DenghangTests") {
  ...
  property("split_seqnth_sat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/split_seqnth_sat.smt2", "sat")
  property("split_len_sat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/split_len_sat.smt2", "sat")
  property("split_len_unsat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/split_len_unsat.smt2", "unsat")
  property("split_seqat_sat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/split_seqat_sat.smt2", "sat")
  property("split_seqat_unsat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/split_seqat_unsat.smt2", "unsat")
  property("join_sat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/join_sat.smt2", "sat")
  property("join_unsat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/join_unsat.smt2", "unsat")
  property("seq_++_sat.smt2") =
  ...
  property("seq_filter_sat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/seq_filter_sat.smt2", "sat")
  property("seq_filter_unsat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/seq_filter_unsat.smt2", "unsat")
  property("seq_filter_unsat2.smt2") =
    checkFile("tests/hu-benchmarks/sequence/seq_filter_unsat2.smt2", "unsat")
  property("seq_match_all_sat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/seq_match_all_sat.smt2", "sat")
  property("seq_match_all_unsat.smt2") =
    checkFile("tests/hu-benchmarks/sequence/seq_match_all_unsat.smt2", "unsat")
}
