...
; .\{\d\}
(assert (str.in_re X (re.++ re.allchar (str.to_re "{") (re.range "0" "9") (str.to_re "}\u{0a}"))))
; ^[-|\+]?[0-9]{1,3}(\,[0-9]{3})*$|^[-|\+]?[0-9]+$
...
(assert (str.in_re X (re.++ (str.to_re "\u{0a}") (re.union (re.range "A" "Z") (re.range "a" "z")) (re.range "0" "9") (re.union (re.range "A" "Z") (re.range "a" "z")) (re.opt (str.to_re "-")) (re.range "0" "9") (re.union (re.range "A" "Z") (re.range "a" "z")) (re.range "0" "9"))))
(assert (> (str.len X) 9))
(check-sat)
