...
(assert (str.in_re X (re.++ (str.to_re "LOG") (re.+ (re.union (re.range "0" "9") (re.range "A" "Z") (re.range "a" "z") (str.to_re "_"))) (str.to_re "PARSER") (re.+ (re.range "0" "9")) (str.to_re "scn.mystoretoolbar.com\u{13}\u{0a}"))))
; (\+1|\+|1)|([^0-9])
(assert (not (str.in_re X (re.union (re.++ (re.range "0" "9") (str.to_re "\u{0a}")) (str.to_re "+1") (str.to_re "+") (str.to_re "1")))))
