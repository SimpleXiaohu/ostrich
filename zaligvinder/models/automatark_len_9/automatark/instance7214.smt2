...
(assert (str.in_re X (re.++ (str.to_re "BY") (re.+ (re.union (str.to_re " ") (str.to_re "\u{09}") (str.to_re "\u{0a}") (str.to_re "\u{0c}") (str.to_re "\u{0d}"))) (str.to_re "\u{22}The") (re.range "0" "9") (str.to_re "User-Agent:serverUSER-Attached\u{0a}"))))
; (@\s*".*?")|("([^"\\]|\\.)*?")
