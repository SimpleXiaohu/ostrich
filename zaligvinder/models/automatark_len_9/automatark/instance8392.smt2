...
(assert (not (str.in_re X (re.++ (re.union (re.++ (re.opt (str.to_re "0")) (re.range "1" "9")) (re.++ (str.to_re "1") (re.range "0" "2"))) (str.to_re ":: ") (re.union (str.to_re "AM") (str.to_re "PM")) (str.to_re "\u{0a}") (re.range "0" "5") (re.range "0" "9") (re.range "0" "5") (re.range "0" "9")))))
...
(assert (str.in_re X (str.to_re "as.starware.com%3fUser-Agent:hostie\u{0a}")))
