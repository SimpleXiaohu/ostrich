...
(assert (str.in_re X (re.++ (re.++ (str.to_re "") (re.++ (re.* (re.union (str.to_re " ") (re.union (str.to_re "\u{0b}") (re.union (str.to_re "\u{0a}") (re.union (str.to_re "\u{0d}") (re.union (str.to_re "\u{09}") (str.to_re "\u{0c}"))))))) (re.++ (re.++ ((_ re.loop 1 1) (re.range "A" "Z")) ((_ re.loop 2 15) (re.range "a" "z"))) (re.*? (re.++ (re.opt (re.union (str.to_re "-") (re.union (str.to_re "|") (re.union (str.to_re " ") (re.union (str.to_re "v") (re.union (str.to_re "o") (re.union (str.to_re "n") (str.to_re " ")))))))) (re.++ ((_ re.loop 1 1) (re.range "A" "Z")) ((_ re.loop 2 15) (re.range "a" "z")))))))) (str.to_re ""))))
