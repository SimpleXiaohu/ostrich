...
(assert (str.in_re X (re.++ (str.to_re "S") (re.++ (str.to_re "E") (re.++ (str.to_re "N") (re.++ (str.to_re " ") (re.++ (str.to_re "\\") (re.++ ((_ re.loop 1 1) (str.to_re "d")) (re.++ (str.to_re " ") (re.++ (str.to_re "\\") (re.++ ((_ re.loop 8 8) (str.to_re "w")) (re.++ (str.to_re " ") (re.++ (str.to_re "\\") (re.++ ((_ re.loop 1 2) (str.to_re "w")) (re.++ (str.to_re " ") ((_ re.loop 1 2) (re.++ (re.opt (re.union (str.to_re "-") (str.to_re "+"))) (re.++ (re.* (re.range "0" "9")) (re.++ (str.to_re "\\") (re.++ (re.opt (re.diff re.allchar (str.to_re "\n"))) (re.* (re.range "0" "9"))))))))))))))))))))))
